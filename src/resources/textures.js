...
// 第二块展板图片地址
billboardTextures.musicTexture ='../src/jsm/myui.png';
// 第三块展板图片地址
...
// 文字图片地址
let inputText = {};
inputText.terpSolutionsText = '../src/jsm/terp-solutions-text.png';  ////第一块板下面的文字
inputText.activities = '../src/jsm/activities_text.png';  //右下角的文字图片
inputText.bagholderBetsText = '../src/jsm/bagholderbets-text.png';  //第二块板下面的文字
inputText.homeSweetHomeText = '../src/jsm/home-sweet-home-text.png'; //第三块板下面的文字
...
// 链接的跳转地址
let URL = {};
URL.blog ='https://guan101.github.io/';  // 第一块板链接地址
URL.music = 'https://guan101.github.io/wenui/#/';  // 第二块板链接地址
URL.fund = 'https://juejin.cn/user/4477663475666014/posts';  // 第三块板链接地址
